    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header bg-white">
                <h5 class="mb-0"><i class="bi bi-info-circle"></i> Detail Laporan Penyaluran</h5>
            </div>
            <div class="card-body">
                <!-- Info Penyaluran -->
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <table class="table table-borderless table-sm">
                            ...
                            <tr>
                                <th>Volunteer</th>
                                <td>: {{ $penyaluran->volunteer->nama_volunteer }}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="card bg-success bg-opacity-10 border-success">
                            <div class="card-body text-center">
                                ...
                                <h2 class="text-success fw-bold mb-0">Rp {{ number_format($penyaluran->jumlah_disalurkan, 0, ',', '.') }}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="d-flex justify-content-between gap-2">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('volunteer.penyaluran.edit', $penyaluran->id_penyaluran) }}" class="btn btn-warning">
