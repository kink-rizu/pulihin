...
@section('title', 'Edit Laporan Penyaluran')
@section('page-title', 'Edit Laporan Penyaluran')
    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header bg-white">
                <h5 class="mb-0"><i class="bi bi-pencil"></i> Edit Laporan Penyaluran</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('volunteer.penyaluran.update', $penyaluran->id_penyaluran) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                            ...
                            placeholder="Jelaskan detail penyaluran bantuan">{{ old('keterangan', $penyaluran->keterangan) }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @error('foto_penyaluran')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Upload foto baru jika ingin mengganti (JPG, PNG, max 2MB)</small>
                    </div>

                    <div class="d-flex justify-content-between gap-2">
                        <a href="{{ route('volunteer.penyaluran.show', $penyaluran->id_penyaluran) }}" class="btn btn-secondary">
